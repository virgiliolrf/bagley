"""Gera data/dataset.jsonl — v7: v6 + Kali tools corpus + filtro non-ASCII.

Diferenças vs v6:
- Kali tools multi-turn (kali_tools.ALL) × 3 oversample
- CTF wiki agora filtra páginas com <80% ASCII (remove leak chinês)
- Mantém resto do v6 idêntico
"""
...
def build(out_path: Path, raw_dir: Path, seed: int = 42) -> int:
    ...
    # ---- Exploit dev (v6) com filtro non-ASCII ----
