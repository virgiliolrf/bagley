"""Gera data/dataset.jsonl — v8: v7 + anti-hallucination + output interpretation + AD/Cloud/Web deep.

Oversamples calibrados:
  anti_hallucination × 3   (crítico — precisa consolidar "não sei")
  output_interpretation × 5 (gap real do eval 2.5/10)
  ad_advanced × 2
  cloud_pentest × 2
  web_deep × 3              (alta prioridade corp)
  network_specific × 3
  wireless_mobile × 2
  osint_advanced × 3

v7 base mantém seu oversample original.
"""
